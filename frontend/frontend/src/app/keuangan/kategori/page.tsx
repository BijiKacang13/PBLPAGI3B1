...
export default function KategoriAkun() {
  ...
  const data = [
    { kode: "1-0000", nama: "Aktiva" },
    { kode: "2-0000", nama: "Kewajiban" },
  ];
          ...
          <table className="w-full text-sm text-gray-700">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="text-left px-4 py-2">Kategori Akun</th>
              </tr>
            </thead>
            <tbody>
              {data.map((item, index) => (
...
/* Modal Component */
// // function TambahKategori({ open, onClose }: { open: boolean; onClose: () => void }) {
// //   if (!open) return null;
