  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-800 pb-20">
      ...
      <div className="mt-4 w-[90%] max-w-md mx-auto bg-white rounded-2xl shadow-md p-5">
        {/* Judul */}
        <h2 className="text-center font-semibold text-gray-800 mb-4">DATA KEGIATAN</h2>
      ...
      {/* ✅ Modal Tambah kegiatan muncul hanya jika openModal = true */}
      <TambahKegiatan open={openModal} onClose={() => setOpenModal(false)} />
    </div>
  );
}
